...
1. Arxiv Daily Digest
   ...
   ```bash
   python examples/workflow_corpus/execute_workflow.py `
     --workflow examples/workflow_corpus/arxiv_daily_digest/workflow.json `
...
2. Recipe Generator
   ...
   ```bash
   python examples/workflow_corpus/execute_workflow.py `
     --workflow examples/workflow_corpus/recipe_meal_plan/workflow.json `
...
3. Tetris Game Generator
   ...
   ```bash
   python examples/workflow_corpus/execute_workflow.py `
     --workflow examples/workflow_corpus/tetris_game/workflow.json `
...
4. Travel Recommendation Generator
   ...
   ```bash
   python examples/workflow_corpus/execute_workflow.py `
     --workflow examples/workflow_corpus/travel_recommendation/workflow.json `
...
5. Feng Shui Advisor
   ...
   ```bash
   python examples/workflow_corpus/execute_workflow.py `
     --workflow examples/workflow_corpus/Fengshui_analysis/workflow.json `
...
```bash
python examples/workflow_corpus/invest/stock_analysis.py
```
