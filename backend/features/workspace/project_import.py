...
def _install_tool(spec: dict) -> dict:
    ...
    import shutil
    import tempfile
    # Checked against its own files: a class the entry imports from a
    # sibling module is read from the folder.
    ...
    try:
        ...
        stored = custom_tools.validate_spec(spec, tools_registry.builtin_names(), folder=staging)
