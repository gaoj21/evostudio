...
export default function TopBar({
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        { label: 'Evaluation & Evolve', onClick: onEvolve, disabled: !graphId },
        ...
        {
          key: 'reset-memory',
          label: `Reset memory (backs up first) ${resetMemoryKeys}`,
          onClick: onResetMemory,
          disabled: !graphId,
        },
        {
          key: 'memory',
          label: showMemory ? 'Hide memory on canvas' : 'Show memory on canvas',
        ...
        },
        {
          key: 'implied',
          label: showImplied
            ? `Hide implied edges (${impliedCount})` : `Show implied edges (${impliedCount})`,
          onClick: onToggleImplied,
          disabled: !graphId || !impliedCount,
        },
      ],
    },
    {
