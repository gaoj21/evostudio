...
(`examples/credit_risk/skills/credit_risk_taxonomy`), but the dataset has no
...
Run from the repository root (needs DEEPSEEK_API_KEY in .env):
    .venv/bin/python credit_risk/dataset/build_06_v04_risk_labels.py --selftest
    .venv/bin/python credit_risk/dataset/build_06_v04_risk_labels.py
"""
...
TAXONOMY_MD = os.path.join(os.path.dirname(__file__), "..", "..",
                           "examples", "credit_risk", "skills",
