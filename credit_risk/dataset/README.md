...
.venv/bin/python data/credit_risk_dataset/build_02b_verify_events.py # EDGAR 8-K body verification
.venv/bin/python data/credit_risk_dataset/build_03_samples.py        # writes v0.1/
.venv/bin/python data/credit_risk_dataset/build_04_v02.py            # v0.1 -> v0.2 (post-processing only)
.venv/bin/python data/credit_risk_dataset/build_05_v03.py            # v0.2 -> v0.3 (noise annotation only)
.venv/bin/python data/credit_risk_dataset/build_06_v04_risk_labels.py # v0.3 -> v0.4 (risk-type silver labels, needs DEEPSEEK_API_KEY)
```
...
(`examples/credit_risk/skills/credit_risk_taxonomy`) when the headline
