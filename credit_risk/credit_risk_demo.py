...
Run from the repository root:
    ...
    python examples/credit_risk/credit_risk_demo.py
"""
...
STORE_DIR = os.path.join("credit_risk", "output", "store")
LOG_PATH = os.path.join("credit_risk", "output", "assessment_log.json")
