...
credit_risk_dataset (credit_risk/dataset/v0.2).
...
Usage (from repo root):
    python examples/credit_risk/run_dataset_eval.py --dedup-only
    python examples/credit_risk/run_dataset_eval.py --n-samples 2 --max-days 5
    python examples/credit_risk/run_dataset_eval.py --input credit_risk/dataset/v0.2/dev.jsonl
"""
...
OUT_DIR = os.path.join("credit_risk", "output", "dataset_eval")
...
def main():
    ...
    parser.add_argument("--input", default="credit_risk/dataset/v0.2/dev.jsonl")
