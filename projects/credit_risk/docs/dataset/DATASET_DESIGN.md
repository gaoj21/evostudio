...
.venv/bin/python projects/credit_risk/dataset/builders/build_02_match_news.py      # 5.7GB CSV 一遍过
.venv/bin/python projects/credit_risk/dataset/builders/build_02b_verify_events.py  # 8-K 正文核实
.venv/bin/python projects/credit_risk/dataset/builders/build_03_samples.py         # -> v0.1/
.venv/bin/python projects/credit_risk/dataset/builders/build_04_v02.py             # -> v0.2/(去重标注+切分)
.venv/bin/python projects/credit_risk/dataset/builders/build_05_v03.py             # -> v0.3/(噪音标注)
.venv/bin/python projects/credit_risk/dataset/builders/build_06_v04_risk_labels.py # -> v0.4/(风险类型银标,需 DEEPSEEK_API_KEY)
```
