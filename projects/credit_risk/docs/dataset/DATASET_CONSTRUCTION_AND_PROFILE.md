# Credit Risk Monitoring 数据集：历史构建方法与父版本数据说明

> **2026-09-14 更新：本文的 100 家公司 / 107 条轨迹统计属于历史父版本，已归档。** 最终版移除 54 条不符合当前评测规则的轨迹，现为 53 家公司 / 53 条轨迹 / 648 条观察记录 / 1,006 份独立材料。当前统计与 Slides 口径请使用 [DATASET_CURRENT_PROFILE.md](DATASET_CURRENT_PROFILE.md)。下文保留当时的构建过程与配置描述，不作为当前版本使用指南。
