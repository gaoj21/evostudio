...
.venv/bin/python projects/credit_risk/dataset/builders/build_02b_verify_events.py  # 8-K body verification
.venv/bin/python projects/credit_risk/dataset/builders/build_03_samples.py         # -> v0.1/
.venv/bin/python projects/credit_risk/dataset/builders/build_04_v02.py             # -> v0.2/ (dedup + split)
.venv/bin/python projects/credit_risk/dataset/builders/build_05_v03.py             # -> v0.3/ (noise audit)
.venv/bin/python projects/credit_risk/dataset/builders/build_06_v04_risk_labels.py # -> v0.4/ (risk-type silver labels; needs DEEPSEEK_API_KEY)
```
