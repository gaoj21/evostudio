...
from credit_risk.studio.releases import label_for
...
def build(source, output):
    ...
    manifest={'version':'eligible-trajectories-1.0','parent_release':source.name,
      ...
      'eligibility_code_sha256':hashlib.sha256(Path(__import__('credit_risk.studio.releases',fromlist=['__file__']).__file__).read_bytes()).hexdigest()}
