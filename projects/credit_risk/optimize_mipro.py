...
Run from the repository root:
    python examples/projects/credit_risk/optimize_mipro.py --selftest   # one sample, no optimizer
    python examples/projects/credit_risk/optimize_mipro.py              # full optimization
"""
...
TRAIN_JSONL = "projects/credit_risk/dataset/v0.2/train.jsonl"
OUT_DIR = os.path.join("projects", "credit_risk", "output", "mipro")
